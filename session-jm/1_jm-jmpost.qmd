...
Currently, the LOOIC does not work here yet, because the `log_lik` is not included in the samples. There is an ongoing discussion on [GitHub](https://github.com/Genentech/jmpost/issues/446) about this topic.
