...
mcmc_trace(post_df, pars = c("theta_b0", "theta_ks", "theta_kg", "omega_0", "omega_s", "omega_g", "sigma"))
mcmc_pairs(post_df, pars = c("theta_b0", "theta_ks", "theta_kg", "omega_0", "omega_s", "omega_g", "sigma"))
```
