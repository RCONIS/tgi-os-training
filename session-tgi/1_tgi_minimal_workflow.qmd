...
$$
\begin{align*}
\mu_{s} &\sim \text{LogNormal}(\log(0.1), 10) \\
\mu_{g} &\sim \text{LogNormal}(\log(0.1), 10) 
\end{align*}
$$
...
# Define the priors
priors <- c(
  prior(normal(log(34), 5), nlpar = "lmu0"),
  prior(normal(log(0.1), 1), nlpar = "ls"),
  prior(normal(log(0.1), 1), nlpar = "lg"),
  prior(normal(0, 5), nlpar = "tphi"),
  prior(normal(log(20), 1), nlpar = "lmu0", class = "sd"),
  prior(normal(log(0.1), 1), nlpar = "ls", class = "sd"),
  prior(normal(log(0.1), 1), nlpar = "lg", class = "sd"),
  prior(normal(log(0.1), 1), nlpar = "tphi", class = "sd"),
  prior(normal(0.1, 1), nlpar = "ltau")
)
...
fit <- brm(
  ...
  control = CONTROL, refresh = REFRESH, thin = 2, # THIN,
  backend = "cmdstanr"
)
