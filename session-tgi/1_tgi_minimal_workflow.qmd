...
plot(post_df$b_ls_Intercept)
plot(post_df$b_lg_Intercept)
plot(plogis(post_df$b_tphi_Intercept))
plot(log(post_df$sd_id__lmu0_Intercept))
plot(log(post_df$sd_id__lg_Intercept))
plot(log(post_df$sd_id__ls_Intercept))
plot(log(post_df$sd_id__tphi_Intercept))
