...
mcmc_trace(post_df, pars = c("theta_b0", "theta_kg", "theta_poverc", "theta_c", "sigma"))
mcmc_dens_overlay(post_df, pars = c("b_lb0_Intercept", "b_lkg_Intercept", "b_lpoverc_Intercept", "b_lc_Intercept", "b_tau_Intercept"))

mcmc_pairs(post_df, pars = c("theta_b0", "theta_kg", "theta_poverc", "theta_c", "sigma"))
```
